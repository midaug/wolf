...
CREATE TABLE `user` (
  ...
  app_ids text,
  ukey varchar(36) comment 'Signature authentication key',
  usecret varchar(36) comment 'Signature authentication secret',
  manager varchar(32) comment 'super,admin,NULL',
  status smallint DEFAULT 0,
  auth_type smallint DEFAULT 1 comment 'user authentication type, 1: password, 2: LDAP, 3: usersign',
